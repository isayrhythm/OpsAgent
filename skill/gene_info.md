...
version: 1
description: 当用户请求查询水稻、玉米或大豆基因的基本信息、注释、功能、位置、别名对应关系或关联性状文本块时触发
trigger: 查询基因信息、基因注释、基因功能、基因位置、基因长度、GO注释、KEGG注释、结构域、转录本、关联性状、文献信息、gene info、gene annotation、rice gene、水稻基因、maize gene、玉米基因、soybean gene、大豆基因、ID转换、基因别名转换
